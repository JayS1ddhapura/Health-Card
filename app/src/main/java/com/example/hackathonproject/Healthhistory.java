    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        caseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentCase = new Intent ("Healthhistory");
            }
        });
        ...
        medicineButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentMedicine = new Intent(Healthhistory.this, Medicine.class);
        ...
        labReportButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentLabReport = new Intent(Healthhistory.this,Labreport.class);
